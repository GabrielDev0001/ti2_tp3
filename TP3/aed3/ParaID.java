...
public class ParaID implements aed3.RegistroArvoreBMais<ParaID> {
  ...
  public ParaID(int n1) {
    this(n1, -1);
  }

  public ParaID(int n1, int n2) {
    try {
  ...
  @Override
  public ParaID clone() {
    return new ParaID(this.id1, this.id2);
  }
