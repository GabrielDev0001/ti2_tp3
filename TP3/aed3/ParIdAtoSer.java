...
public class ParIdAtoSer implements aed3.RegistroArvoreBMais<ParIdAtoSer> {
  ...
  public ParIdAtoSer(int n1) {
    this(n1, -1);
  }

  public ParIdAtoSer(int n1, int n2) {
    try {
  ...
  @Override
  public ParIdAtoSer clone() {
    return new ParIdAtoSer(this.id1, this.id2);
  }
  ...
  public int compareTo(ParIdAtoSer a) {
    if (this.id1 != a.id1)
